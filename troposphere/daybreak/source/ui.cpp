...
namespace dbk {
        ...
        bool CreateDowngradeFlag(DowngradePatchType type) {
            ...
            switch (type) {
                case DowngradePatchType::Firmware20x:
                    path = is_emummc ? "sdmc:/dg_emummc.flag" : "sdmc:/dg_emmc.flag";
                    break;

                case DowngradePatchType::Firmware19x:
                    path = is_emummc ? "sdmc:/dg_19_emummc.flag" : "sdmc:/dg_19_emmc.flag";
                    break;
            }
    ...
    Result ValidateUpdateMenu::GetUpdateInformation() {
         ...
         * Patch the save-data index in 8000000000000000.
         */
